...
local Config = {
    ...
    ServiceId       = 32506, -- Your PlatoBoost Service ID
    PlatoSecret     = "681f3e3b-49da-4a26-bcfa-0ebec4408ed0", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "01927471946", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/blyfatimah599-cloud/keysystem/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "X GUI", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "X GUI AIMBOT", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "X GUI", -- The main title shown at the top of the GUI
    HubDescription  = "X GUI AIMBOT" -- The text shown below the title
}
